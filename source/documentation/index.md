...
During the transition period, NCTS will observe and apply these business ([Rules B](/guides/excise-movement-control-system-api-tis/documentation/rules-b.html)) and technical ([Rules E](/guides/excise-movement-control-system-api-tis/documentation/rules-e.html)) rules as defined in this document.
...
You can find the changelog in the [excise-movement-control-system-api-tis](https://github.com/hmrc/excise-movement-control-system-api-tis/wiki/NCTS-Phase-5-Technical-Interface-Specification-(TIS)-changelog) GitHub wiki.
